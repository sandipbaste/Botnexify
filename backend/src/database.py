...
class DatabaseManager:
    ...
    # In src/database.py, update the execute_query method:
    ...
    def initialize_database(self):
        ...
        try:
            ...
            if not tables_exist:
                ...
                tables_with_updated_at = ['users', 'admins', 'websites', 'user_subscriptions', 'payment_transactions']
    ...
    def save_website(self, website_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            # Convert JSON fields
            if 'features' in website_data and isinstance(website_data['features'], (list, dict)):
                website_data['features'] = json.dumps(website_data['features'])
